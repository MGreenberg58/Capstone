...
if __name__ == "__main__":
    ...
    for name in names:
        ...
        plt.title(f"Sensitivity of Pf to {name}", y=-0.3, fontsize=24)
        plt.subplots_adjust(bottom=0.25)
        plt.xlabel("Boom Tip X (m)", fontsize=18)
        plt.ylabel("Boom Tip Y (m)", fontsize=18)
        ...
        plt.title(f"Sensitivity of Reliability Index β to {name}", y=-0.3, fontsize=24)
        plt.subplots_adjust(bottom=0.25) 
        plt.xlabel("Boom Tip X (m)", fontsize=18)
        plt.ylabel("Boom Tip Y (m)", fontsize=18)
        plt.xticks(fontsize=14)
    ...
    plt.xlabel("Boom Length Along Stability Frontier (m)", fontsize=18)
    plt.ylabel("Probability Sensitivity", fontsize=18)
    plt.title("Change in Failure Probability as Payload Mass Changes", y=-0.3, fontsize=24)
    plt.subplots_adjust(bottom=0.25) 
    plt.xticks(fontsize=14)
    plt.yticks(fontsize=14)
    plt.grid(True)
    ...
    plt.xlabel("Boom Length Along Stability Frontier (m)", fontsize=18)
    plt.ylabel("Probability Sensitivity", fontsize=18)
    plt.title("Change in Failure Probability as Boom Length Changes", y=-0.3, fontsize=24)
    plt.subplots_adjust(bottom=0.25) 
    plt.xticks(fontsize=14)
    plt.yticks(fontsize=14)
    plt.grid(True)
    ...
    plt.xlabel("Boom Length Along Stability Frontier (m)", fontsize=18)
    plt.ylabel("Probability Sensitivity", fontsize=18)
    plt.title("Change in Failure Probability as Theta Changes", y=-0.3, fontsize=24)
    plt.subplots_adjust(bottom=0.25) 
    plt.xticks(fontsize=14)
    plt.yticks(fontsize=14) 
    plt.grid(True)
    ...
    plt.xlabel("Boom Length Along Stability Frontier (m)", fontsize=18)
    plt.ylabel("Probability Sensitivity", fontsize=18)
    plt.title("Change in Failure Probability Along Stability Frontier", y=-0.3, fontsize=24)
    plt.subplots_adjust(bottom=0.25) 
    plt.legend()
    plt.grid(True)
    ...
    plt.xticks(fontsize=14)
    plt.yticks(fontsize=14)
    plt.xlabel("Horizontal Boom Reach (m)", fontsize=18)
    plt.ylabel("∂Pf / ∂μ", fontsize=18)
    plt.title("Probability Sensitivity vs Horizontal Reach", y=-0.3, fontsize=24)
    plt.subplots_adjust(bottom=0.25) 
    plt.legend()
    plt.grid(True)
